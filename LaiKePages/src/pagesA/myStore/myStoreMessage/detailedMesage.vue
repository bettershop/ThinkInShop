<template>
    <div class='box'> 
        ...
        <div 
            style='border-radius: 0 0 24rpx 24rpx;' 
        ...
        <div 
            style='border-radius: 24rpx 24rpx 0 0;margin-top:24rpx;height: 100vh;' 
            class='detailed-content' 
            v-for="(item,index) in list" :key="index">
...
<script>
    export default {
        ...
        onShow () {
            ...
            this.title = this.language.storeMessage.title
        },
        methods: {
            changeLoginStatus () {
            ...
            getDetailedMesageData () {
                var me = this
                var data = {
                    api: 'mch.App.Notice.NoticeDetails',
                    id: this.id,
                }
