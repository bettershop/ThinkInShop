    ...
    <div class='box systemMesage'>
        ...
        <toload :load="load">
            <div class="m_top">
                ...
                <!-- 全部未读 -->
                <div v-if="noread>0" class="top_read flex1" @tap="readAll"><img class="top_readimg" :src="read"></div>
                <!-- 全部已读 -->
                <div v-else class="top_read flex1" style="color: #c2c2c2;"><img class="top_readimg" :src="readed"></div>
                <!-- 编辑 -->
                <div class="top_read top_ed" v-if="opeshow&&total>0" v-show="list.length" @click="onEdit">{{language.message.edit}}</div>
                <!-- 完成 -->
