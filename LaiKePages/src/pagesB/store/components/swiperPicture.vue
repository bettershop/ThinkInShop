<template>
    ...
    :style="'background: linear-gradient(90deg, '+ bgColor[0].item +' 50%, '+ bgColor[1].item +' 100%);margin-top:'+marginTop+'px;padding: 0 '+paddinglr+'px;'">
        

        <image :src="imgUrls[0].img" v-if="imageH" :style="{height: imageH + 'px'}" mode="aspectFill" @click="$emit('toUrl', imgUrls[0].info[1].value)"></image>
    </view>
</template>
