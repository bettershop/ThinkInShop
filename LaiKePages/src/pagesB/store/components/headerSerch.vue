<template>
    <div>
        <div class="container_top" :style="{height: height, background: `linear-gradient(90deg,${bgColor[0].item} 0%,${bgColor[1].item} 100%)`, paddingBottom: 0}">
            ...
            <!-- #endif -->
            <!-- #ifdef MP -->
            <heads :title="title" v-if="isTop" :border="true" :returnFlag="true" :bgColor="bgColor" ishead_w="1"></heads>
            <!-- #endif -->
            <div class="header-wrap" :style="{position: isTop ? 'fixed' :'relative', zIndex: isTop ? 999 : 1 }">
                <view class="header" :style="'background: linear-gradient(90deg, '+ bgColor[0].item +' 0%, '+ bgColor[1].item +' 100%);margin-top:'+ mbConfig +'rpx;'">
