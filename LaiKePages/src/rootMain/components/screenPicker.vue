    ...
    <view v-if="showScreenPicker">
      <view class="screen-picker-modal">
        ...
        <view class="content">
          ...
          <view class="screen-text">{{language.search2.searchRes.pl}}</view>
          <view class="type-options">
            <view class="option" :class="{ active: sort == 'asc' }" @tap="setSort('asc')">{{language.search2.searchRes.sx}}</view>
            <view class="option" :class="{ active: sort == 'desc' }" @tap="setSort('desc')">{{language.search2.searchRes.jx}}</view>
          </view>
          <view class="screen-text">{{language.search2.searchRes.jgqj}}</view>
          ...
          <view class="screen-text">{{language.search2.searchRes.pp}}</view>
          <view class="type-options">
            <view 
              class="option" 
          ...
          <view class="buttons">
            <button @tap="reset">{{language.search2.searchRes.zz}}</button>
            <button @tap="confirm">{{language.search2.searchRes.qd}}</button>
          </view>
        </view>
      </view>
    </view>
