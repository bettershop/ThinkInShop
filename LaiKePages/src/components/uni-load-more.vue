<template>
    <view class="load-more">
        ...
        <text class="loading-text" :style="{color:color}">{{loadingType === 0 ? contentText.contentdown : (loadingType
            === 1 ? contentText.contentrefresh : language.loadMore.contentText.contentnomore)}}
        </text>
    </view>
</template>
...
<script>
    export default {
        ...
        created () {
            ...
            this.contentText = this.language.loadMore.contentText
        },
    }
</script>
