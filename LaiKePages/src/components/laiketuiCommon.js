...
import zh_TW from '../common/lang/zh_TW.js'
import Vue from 'vue'
...
// const LKT_WEBSOCKET = `${protocol}://${host}/wss/comps/onlineMessage/`;

//PHP
// const LKT_WEBSOCKET = 'wss://tp.dev.laiketui.net/wss/' 
const LKT_WEBSOCKET = 'ws://localhost:21898/apis/onlineMessage/'
/*
 * websocket 其他消息WSS地址 
 */
// const LKT_BUS_WEBSOCKET = 'ws://localhost:21802/comps/msgbus/'

/**
 * 接口地址：网关域名
 */

// const LKT_ROOT_URL = 'http://192.168.0.19:21801/comps'  
const LKT_ROOT_URL = 'http://localhost:21898/apis'  

// //java 
// const apiprotocol = window.location.protocol ;
// const LKT_ROOT_URL = `${apiprotocol}://${host}/
// const LKT_ROOT_URL = 'https://java.houjiemeishi.com'
// const LKT_ROOT_URL = 'http://192.168.0.21:21801/c还是omps'
//PHP
 ...
 * 带版本号的路径
 */
// const LKT_ROOT_VERSION_URL = `${apiprotocol}://${host}/pic/`
...
function laikeVisitorToLogin () {
    ...
    }else if(uni.getStorageSync('language') == 'zh_TW'){
        toast = zh_TW.laiketuiCommon
    }
