...
import Vue from 'vue'
import zh_TW from "../common/lang/zh_TW";
 ...
 */
//java
const LKT_WEBSOCKET = 'wss://java.dev.laiketui.net/wss/comps/onlineMessage/'  

/**
 * 接口地址：网关域名
 */
//java
const LKT_ROOT_URL = 'https://java.dev.laiketui.net' 
 ...
 * 带版本号的路径
 */
const LKT_ROOT_VERSION_URL = 'https://java.dev.laiketui.net/pic/'
 ...
 * 来客电商H5默认路径s
 */ 
const LKT_H5_DEFURL = 'https://java.dev.laiketui.net/H5/#/' 
 ...
 */ 
function formatPrice(basePrice,exchangeRate) {
