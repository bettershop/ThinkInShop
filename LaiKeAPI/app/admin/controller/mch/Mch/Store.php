    ...
    public function AddAdmin()
    {
        ...
        if ($r_mch)
        {
            ...
            else
            {
                if($id != '' && $id != 0)
                {
                    $sql0 = "select id from lkt_mch_admin where store_id = '$store_id' and mch_id = '$mch_id' and mch_store_id = '$mch_store_id' and account_number = '$account_number' and id != '$id' ";
                }
                else
                {
                    $sql0 = "select id from lkt_mch_admin where store_id = '$store_id' and mch_id = '$mch_id' and mch_store_id = '$mch_store_id' and account_number = '$account_number' ";
                }
                $r0 = Db::query($sql0);
                if($r0)
                {
