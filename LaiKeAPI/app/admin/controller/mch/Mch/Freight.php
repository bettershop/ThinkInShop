...
class Freight extends BaseController
{
    ...
    public function AddFreight()
    {
        ...
        $data = array('store_id'=>$store_id,'admin_name'=>$admin_name,'mch_id'=>$mch_id,'fid'=>$fid,'lang_code'=>$lang_code,'name'=>$name,'type'=>$type,'default_freight'=>$default_freight,'hidden_freight'=>$hidden_freight,'no_delivery'=>$no_delivery,'threeIdsList'=>$threeIdsList,'operator_id'=>$operator_id,'operator'=>$operator,'source'=>2);
    ...
    public function FreightSetDefault()
    {
        ...
        $data = array('store_id'=>$store_id,'admin_name'=>$admin_name,'mch_id'=>$mch_id,'id'=>$id,'operator_id'=>$operator_id,'operator'=>$operator,'source'=>2);
        $freight = new FreightPublicMethod();
    ...
    public function Index()
    {
        ...
        $data = array('store_id'=>$store_id,'fid'=>0,'mch_id'=>$mch_id,'lang_code'=>$lang_code,'status'=>'','type'=>'','name'=>'','pageNo'=>1,'pageSize'=>$pageSize);

        $freight = new FreightPublicMethod();
        $freight_list = $freight->freight_list_0($data);
    ...
    public function RelatedProducts()
    {
        ...
        $data = array('store_id'=>$store_id,'mch_id'=>$mch_id,'id'=>$id,'page'=>$page,'pagesize'=>$pagesize,'operator_id'=>$operator_id,'operator'=>$operator,'source'=>1);
        $freight = new FreightPublicMethod();
