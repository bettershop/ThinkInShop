                    ...
                    else
                    {
                        ...
                        { // 直播订单
                            ...
                            if($r_0_0)
                            {
                                ...
                                $sql_0_2 = "update lkt_living_anchor set onlyamount = onlyamount + '$commission_0_0',tx_commission = tx_commission + '$commission_0_0' where store_id = '$store_id' and user_id = '$anchor_id_0_0' ";
                                $r_0_2 = Db::execute($sql_0_2);
                                if($r_0_2 < 1)
                                {
                                    Db::rollback();
                                    $this->testLog(__METHOD__ . ":" . __LINE__ . "修改直播表失败！sql:" . $sql_0_2);
                                }
                            }
                        }
                    }
