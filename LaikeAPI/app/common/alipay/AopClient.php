...
class AopClient {
	...
	public function sdkExecute($request,$data) {



		$this->postCharset = $data->charset;

		$this->rsaPrivateKeyFilePath = '';

		$this->privatekey = $data->rsaPrivateKey;
		...
		$params['alipay_sdk'] = $data->alipaySdkVersion;
		...
		return htmlspecialchars_decode(http_build_query($params));
