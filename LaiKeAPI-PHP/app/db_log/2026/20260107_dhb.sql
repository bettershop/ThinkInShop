...
ADD COLUMN `official_account_appid` char(18) NULL COMMENT '公众号appID' AFTER `appsecret`,
ADD COLUMN `official_account_appsecret` char(32) NULL COMMENT '公众号app密钥' AFTER `official_account_appid`;


ALTER TABLE `lkt_admin` 
MODIFY COLUMN `token` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL AFTER `tel`;

ALTER TABLE `lkt_user` 
MODIFY COLUMN `access_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '授权id' AFTER `preferred_currency`;