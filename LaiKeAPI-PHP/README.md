...
## 本地联调（现有服务，无 Docker/小皮）

本机若 `80` 端口被系统 Apache 占用，可直接使用本地网关端口方案：

- 网关地址：`http://www.laike.com:82/gw`
- 数据库：`127.0.0.1:3306`，`root/123456`，`lkt_db`
...
```bash
ACCOUNT=你的账号 PASSWORD=你的密码 bash scripts/address_gateway_smoke.sh
```
