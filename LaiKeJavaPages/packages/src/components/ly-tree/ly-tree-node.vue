<template>
	<view ref="node"
		...
		:class="{ 
            ...
            'leve-one': node.level == 1,
            'leve-twe': node.level != 1
		}"
		role="treeitem" 
		...
		<view class="ly-tree-node__content" 
			...
			<ly-checkbox v-if="checkboxVisible || radioVisible"
				...
				@check="handleCheckChange(!node.checked)"></ly-checkbox> 
...
<script>
    import LyTreeNode from '@my-miniprogram/src/components/ly-tree/ly-tree-node.vue'
...
<style>
    ...
    /* 引入阿里矢量图 */
	@font-face {
	  font-family: 'ly-iconfont';  /* Project id 3915788 */
	  src: url('//at.alicdn.com/t/c/font_3915788_2k2driiup2l.woff2?t=1677234200140') format('woff2'),
	       url('//at.alicdn.com/t/c/font_3915788_2k2driiup2l.woff?t=1677234200140') format('woff'),
	       url('//at.alicdn.com/t/c/font_3915788_2k2driiup2l.ttf?t=1677234200140') format('truetype');
	}
	.ly-iconfont {
