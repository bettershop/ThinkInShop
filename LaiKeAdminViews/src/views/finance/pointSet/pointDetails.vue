  ...
  <div class="container">
      ...
      <div class="Search-condition">
        <div class="query-input">
          <el-select
            ...
            :placeholder="$t('pointDetails.qxzlx')"
          >
            <el-option
    ...
    <div class="menu-list" ref="tableFather">
      ...
      <template slot="empty">
        ...
        <el-table-column prop="id" :label="$t('pointDetails.xh')"> </el-table-column>
        <el-table-column prop="user_name" :label="$t('pointDetails.yhmc')"> </el-table-column>
        <el-table-column prop="sign_score" :label="$t('pointDetails.jfs')"> 
        </el-table-column>
        <el-table-column prop="typeName" :label="$t('pointDetails.lx')">
          <!-- <template slot-scope="scope">
            {{ getType(scope.row.type)  }}
          </template> -->
        </el-table-column>
        <el-table-column prop="sign_time" :label="$t('pointDetails.rzzcsj')"> </el-table-column>
      </el-table>
...
<script>
import pointDetails from '@/webManage/js/finance/withdrawalManage/pointDetails'
export default pointDetails
</script>

<style scoped lang="less">
@import '../../../webManage/css/finance/withdrawalManage/pointDetails.less';
</style>
