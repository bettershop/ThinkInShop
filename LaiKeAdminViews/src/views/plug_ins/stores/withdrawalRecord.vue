  ...
  <div class="container">
    ...
    <div class="Search">
      <div class="Search-condition">
        <div class="query-input">
          ...
          <el-select
            class="select-input"
            v-model="inputInfo.dkstatus"
            :placeholder="$t('请选择打款状态')"
          >
            <el-option
    ...
    <div class="menu-list" ref="tableFather">
      ...
      >
        ...
        <el-table-column
          prop="status"
          :label="$t('stores.withdrawalAudit.shzt')"
        >
          <template slot-scope="scope">
            <span
              class="ststus"
              ...
              >{{
                scope.row.status == 0
                  ? $t('stores.withdrawalAudit.dsh')
                  : scope.row.status == 1
                  ? $t('stores.withdrawalAudit.shtg')
                  : $t('stores.withdrawalAudit.yjj')
              }}</span
            >
          </template>
        </el-table-column>
        ...
        >
          <template slot-scope="{row}">
            <span>{{row.Bank_card_number || row.email }} </span>
          </template>
        </el-table-column>
        <el-table-column
          prop="refuse"
          :label="$t('stores.withdrawalRecord.bz')"
          width="200"
        >
          <template slot-scope="scope" v-if="scope.row.refuse">
...
<script>
import withdrawalRecord from '@/webManage/js/plug_ins/stores/withdrawalRecord'
