<template>
  <div class="container">
          ...
          <el-form-item class="goos-block" :label="$t('template.addActivity.zssp')" required>
            ...
            <div class="changeUser" style="height: 330px;">
              <el-table :data="ChangeProList" height="100%" :header-cell-style="header">
                ...
                <el-table-column prop="volume" align="center" :label="$t('template.addActivity.kc')">
                  <template slot-scope="{row}">
                    <samp>{{ row.volum || row.num }}</samp>
                  </template>
                </el-table-column>
    ...
    <el-dialog :title="$t('template.addActivity.tjsp')" :visible.sync="dialogVisible3" width="1220px">
      <div class="">
