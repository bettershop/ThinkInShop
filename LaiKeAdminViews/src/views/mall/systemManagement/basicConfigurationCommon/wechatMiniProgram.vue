        ...
        >
          <div class="card">
            ...
            <el-row :gutter="3" style="margin-left: 14px; padding-bottom: 18px">
              ...
              <el-col :lg="8">
                <el-form-item
                  :label="$t('terminalConfig.gzhid')"
                  prop="appId"
                  style="margin-left: 30px"
                >
              
                  <el-input
                    v-model="weiXinForm.official_account_appid"
                    :placeholder="$t('terminalConfig.qsrgzhid')"
                    style="width: 100%"
                  ></el-input>
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="8">
                <el-form-item
                  :label="$t('terminalConfig.gzhmy')"
                  prop="appSecret"
                  style="margin-left: 30px"
                >
                  <el-input
                    v-model="weiXinForm.official_account_appsecret"
                    :placeholder="$t('terminalConfig.qsrgzhmy')"
                    style="width: 100%"
                  ></el-input>
                </el-form-item>
              </el-col>
...
export default {
  ...
  mounted() {
    // this.tabPosition = this.$refs.tab_bun.$children[0].label
    // this.tbl()
  },
  ...
  methods: {
    ...
    tbl(tblId) {
      console.log('543543543543', document.cookie.split(';'));
      this.loadData();
      if (this.tabPosition == "1") {
        this.type = 0;
        this.$router.currentRoute.matched[2].meta.title = this.$t("terminalConfig.wxxcx");
      } else if (this.tabPosition == "2") {
        this.$router.currentRoute.matched[2].meta.title = "APP";
        this.type = 1;
      } else {
        this.$router.currentRoute.matched[2].meta.title =
          this.$t(`terminalConfig.pcsc`);
        this.handleGetConfig()
      }
    },
    //选择一页多少条
    ...
    submitForm(formName) {
      this.$refs[formName].validate(async (valid) => {
        ...
        let param = {
            ...
            official_account_appid: this.weiXinForm.official_account_appid, // 公众号ID
            official_account_appsecret: this.weiXinForm.official_account_appsecret, // 公众号秘钥
          };
        if (valid) {
          if (true) {
