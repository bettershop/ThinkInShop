<template>
  <div class="container">
      ...
      <div class="header">
        <span>{{$t('systemManagement.protocolConfiguration.bjxy')}}</span>
      </div>
      ...
      <el-form :model="ruleForm" label-position="right" ref="ruleForm" label-width="130px" class="form-search">
        <div class="notice">
          ...
          <el-form-item :label="$t('systemManagement.protocolConfiguration.xylx')" required>
            <el-radio-group v-model="ruleForm.protocol_type" :disabled="true">
...
<script>
import editorAgreement from '@/webManage/js/mall/systemManagement/editorAgreement'
export default editorAgreement
</script>

<style scoped lang="less">
@import '../../../../webManage/css/mall/systemManagement/editorAgreement.less';
</style>