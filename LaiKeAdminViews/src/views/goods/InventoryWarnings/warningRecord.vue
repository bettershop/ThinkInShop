  ...
  <div class="container">
      <div class="menu-list" ref="tableFather">
        ...
        :height="tableHeight">
          ...
          <!-- <el-table-column prop="goods_img" label="商品信息" width="200">
            <template slot-scope="scope">
          ...
          <el-table-column prop="num" label="剩余库存">
          </el-table-column>
          <el-table-column prop="total_num" label="商品总库存">
          </el-table-column>
          <el-table-column prop="flowing_num" label="已销售库存">
          </el-table-column>
          <el-table-column prop="add_date" label="预警时间">
            <template slot-scope="scope">
          ...
          <el-table-column prop="content" fixed="right" show-overflow-tooltip label="备注" width="200">
            <template slot-scope="scope">
              <!-- <span class="note">{{ scope.row.content }}</span> -->
