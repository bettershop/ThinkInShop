<template>
  <div class="container">
    ...
    <div class="iframe-content" id="app" style="background-color: #FFFFFF;border-radius: 4px;padding: 20px;">
      <div class="Ranking">
        <div class="Ranking-title">{{$t('reportManagement.businessReport.shddq')}}</div>
      ...
      <div class="allTable">
        <el-table :data="tableData" @sort-change="sortChange" style="width: 100%;"  >
          <el-table-column  prop="store_id" :label="$t('reportManagement.businessReport.shid')" ></el-table-column>
          <el-table-column  prop="name" :label="$t('reportManagement.businessReport.shmc')" ></el-table-column>
          <el-table-column  prop="total" sortable='custom' :label="$t('reportManagement.businessReport.ddsl')"></el-table-column>
        </el-table>
...
<script>
import orderReport from '@/webManage/js/platform/reportManagement/orderReport'
export default orderReport
</script>

<style scoped lang="less">
@import '../../../webManage/css/platform/reportManagement/orderReport.less';
.iframe-content{
        display: flex;
