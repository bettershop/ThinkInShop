  ...
  <div class="container">
    <div class="add-menu">
      ...
      >
        ...
        <el-form-item
          :label="$t('permissions.addmenulevel.cdlx')"
          prop="menutype"
        >
          <el-select
            class="select-input"
            v-model="ruleForm.menutype"
            :placeholder="$t('permissions.addmenulevel.qsrcdlx')"
          >
            <el-option
        ...
        <!-- 路径 -->
        <el-form-item
          :label="$t('permissions.addmenulevel.lj')"
          prop="path"
        ...
        <el-form-item
          :label="$t('permissions.addmenulevel.dlmc')"
          prop="tourname"
        >
          <el-input
            v-model="ruleForm.tourname"
            :placeholder="$t('permissions.addmenulevel.qsrdlmc')"
          ></el-input>
        </el-form-item>
        <el-form-item
          :label="$t('permissions.addmenulevel.dldz')"
          v-if="inputShow !== 1"
        >
          <el-input
            v-model="ruleForm.menuPath"
            :placeholder="$t('permissions.addmenulevel.qsrdldz')"
          ></el-input>
        </el-form-item>
        <el-form-item
        ...
        <el-form-item
          class="upload-img"
          :label="$t('permissions.addmenulevel.dltb')"
          prop="tourlogo"
          v-if="inputShow !== 1"
        >
          <l-upload
...
export default {
  ...
  watch: {
    // 'ruleForm.menutype'(newVal,oldVal) {
    //   if(oldVal || oldVal == 0 ) {
    ...
    if (this.$route.query.menulevel) {
      ...
      if (this.$route.query.menulevel == 2) {
        getMenuLeveInfo({
          ...
          this.ruleForm.menutype = res.data.data.list[0].type;
        ...
        getMenuLeveInfo({
          ...
          this.ruleForm.select_3 = this.ruleForm.select_3 =
