...
// 删除秒杀标签
export const delLabel = request.throttle((params) => {
  return request({
    method: "post",
    params,
  });
...
// 添加/编辑秒杀标签
export const addLabel = request.throttle((params) => {
...
// 添加/编辑秒杀商品
export const addPro = request.throttle((params) => {
  let formData = new FormData();
  for (let [key, value] of entries(params)) {
    formData.append(key, value);
  }
...
// 删除秒杀记录
export const delSecRecord = request.throttle((params) => {
  return request({
    method: "post",
    params,
  });
...
// 删除标签商品
export const delPro = request.throttle((params) => {
  return request({
    method: "post",
    params,
  });
...
// 关闭订单
export const closeOrder = request.throttle((params) => {
  return request({
    method: "post",
    params,
  });
