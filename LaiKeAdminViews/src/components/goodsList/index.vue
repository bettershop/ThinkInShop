<template>
  <div class="goodList">
    ...
    <Table ref="table" no-data-text="暂无数据" @on-selection-change="changeCheckbox" no-filtered-data-text="暂无筛选结果"
           max-height="400" :columns="columns4"
...
<script>
    ...
    import { changeListApi, treeListApi } from '@/api/product';
