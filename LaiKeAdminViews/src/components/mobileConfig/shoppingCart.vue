  ...
  <div class="mobile-config">
    <!-- <div>
        ...
        <div style="display: flex;align-items: center;">
            <div class="quer-but " :class="{'avitive':configObj.pageConfig.shppingType}" @click="upShppingType(true)">
                悬浮效果
            </div>
            <div class="quer-but" :class="{'avitive':!configObj.pageConfig.shppingType}" @click="upShppingType(false)">
                全屏展示
            </div>
        </div>
     </div> -->
