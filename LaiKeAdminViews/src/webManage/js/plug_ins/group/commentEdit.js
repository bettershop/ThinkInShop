...
export default {
  ...
  data () {
    return {
      ...
      star: 0,
      starGroup: [
        this.$t('commentEdit.cp'),
        this.$t('commentEdit.sw'),
        this.$t('commentEdit.yb'),
        this.$t('commentEdit.my'),
        this.$t('commentEdit.hp')
      ],
      isEdit: true,
      //评论图集
      commentImgList: null,
  ...
  created () {
    if (this.$route.query.type) {
      ...
      this.$router.currentRoute.matched[2].meta.title = '修改'
    }
    this.loadData()
  },
  mounted () {},
  methods: {
    ...
    async Save () {
      ...
      let title = '修改评论'
      let param = {
        api: 'plugin.group.AdminGroupOrder.UpdateCommentsDetailInfoById',
        ...
        review: this.mainData.review
          ? decodeURIComponent(this.mainData.review)
          : '',
