    ...
    data() {
        return {
            stateList: [
                {
                    value: '7',
                    label: this.$t('seckill.afterSaleList.dsh')
                },
                {
                    value: '1',
                    label: this.$t('seckill.afterSaleList.tkz')
                },
                {
                    value: '2',
                    label: this.$t('seckill.afterSaleList.tkcg')
                },
                {
                    value: '3',
                    label: this.$t('seckill.afterSaleList.tksb')
                },
                {
                    value: '4',
                    label: this.$t('seckill.afterSaleList.hhz')
                },
                {
                    value: '5',
                    label: this.$t('seckill.afterSaleList.hhcg')
                },
                {
                    value: '6',
                    label: this.$t('seckill.afterSaleList.hhsb')
                },
            ],// 订单状态
            inputInfo: {
                orderNo: null,
