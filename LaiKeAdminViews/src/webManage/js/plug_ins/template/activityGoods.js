    ...
    methods: {
        ...
        async getActGoodsLists() {
            const res = await getActGoodsList({
                ...
                api: 'plugin.template.AdminDiy.GetActGoodsList',
        ...
        switchs(value) {
            actGoodsSwitch({
                ...
                api: 'plugin.template.AdminDiy.ActGoodsSwitch',
                id: value.id
            }).then(res => {
        ...
        moveUp(value) {
            if(value !== 0) {
                actGoodsMove({
                    ...
                    api: 'plugin.template.AdminDiy.ActGoodsMove',
                    id: this.$route.query.id,
        ...
        placedTop(value) {
            ...
            api: 'plugin.template.AdminDiy.ActGoodsTop',
            id: this.$route.query.id,
            goodsId: value.id
            }).then(res => {
                console.log(res);
