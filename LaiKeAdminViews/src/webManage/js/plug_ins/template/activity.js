  ...
  methods: {
    ...
    async activityLists() {
      const res = await activityList({
        ...
        api: 'plugin.template.AdminDiy.ActivityList',
    ...
    switchs(value) {
      activitySwitch({
        ...
        api: 'plugin.template.AdminDiy.ActivitySwitch',
        id: value.id
      }).then(res => {
    ...
    moveUp(value) {
      if(value !== 0) {
        activityMove({
          ...
          api: 'plugin.template.AdminDiy.ActivityMove',
    ...
    // 删除
    Delete(value) {
      this.$confirm(this.$t('template.activity.scqr'), this.$t('template.ts'), {
        ...
        type: 'warning'
          ...
          activityDel({
              ...
              api: 'plugin.template.AdminDiy.ActivityDel',
              id: value.id
          }).then(res => {
              console.log(res);
              if(res.data.code == '200') {
