...
export default {
    ...
    beforeRouteLeave(to, from, next) {
        if (JSON.stringify(this.ruleForm) == sessionStorage.getItem('ruleForm_dist')) {
            next()
        } else {
    ...
    methods: {
        ...
        async getDistributionConfigInfo() {
            ...
            if (info.id) {
                ...
                this.ruleForm.cengji = info.parmamSetsMap.c_cengji ? info.parmamSetsMap.c_cengji.toString() : '2'
            ...
            sessionStorage.setItem('ruleForm_dist', JSON.stringify(this.ruleForm))
            ...
            this.$refs[formName].validate(async (valid) => {
                ...
                if (valid) {
                    try {
                        ...
                        if (this.ruleForm.content && this.ruleForm.content.length > 5000) {
                            this.$message({
