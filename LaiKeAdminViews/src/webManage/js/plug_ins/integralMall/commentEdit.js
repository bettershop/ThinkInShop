...
export default {
  ...
  data() {
    return {
      ...
      starGroup: [this.$t('integralMall.commentEdit.cp'), this.$t('integralMall.commentEdit.sw'), this.$t('integralMall.commentEdit.yb'), this.$t('integralMall.commentEdit.my'), this.$t('integralMall.commentEdit.hp')],
      isEdit: true,
      //评论图集
      commentImgList: null,
      //追评图集
  ...
  methods: {
    ...
    async Save() {
      ...
      let title = '修改评论';
      let param = {
        api: 'plugin.integral.order.updateCommentsDetailInfoById',
