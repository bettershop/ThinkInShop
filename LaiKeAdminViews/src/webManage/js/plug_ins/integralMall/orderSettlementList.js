...
export default {
  ...
  methods: {
    ...
    async loadData() {
      await index({
        api: 'plugin.integral.order.settlementIdex',
    ...
    async Del(id) {
      this.$confirm(this.$t('integralMall.orderSettlementList.scts'), this.$t('integralMall.orderSettlementList.ts'), {
        confirmButtonText: this.$t('integralMall.orderSettlementList.okk'),
        cancelButtonText: this.$t('integralMall.orderSettlementList.ccel'),
        type: 'warning'
      }).then(() => {
        del({
          api: 'plugin.integral.order.settlementDel',
          id: id
        }).then(res => {
          this.demand();
          this.$message({
