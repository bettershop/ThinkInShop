...
export default {
    ...
    methods: {
        ...
        async getButtons() {
            ...
            token:getStorage('laike_admin_uaerInfo').token,
        ...
        async bannerIndexs() {
            const res = await bannerIndex({
                api: 'plugin.bbs.Adminbbs.bannerlist',
        ...
        moveUp(value) {
          ...
          bannerRemove({
            api: 'plugin.bbs.Adminbbs.bannerRemove',
            id: this.tableData[number].id,
        ...
        placedTop(value) {
            bannerMoveTop({
                api: 'plugin.bbs.Adminbbs.bannerMoveTop',
                id: value.id
            }).then(res => {
                console.log(res);
                if(res.data.code == '200') {
        ...
        Edit(value) {
          this.$router.push({
            path: '/plug_ins/tieba/editorSlideShow',
            query: value,
          });
        },
        ...
        Delete(value) {
            this.$confirm(this.$t('template.playlist.qdsc'), this.$t('template.ts'), {
              ...
              type: 'warning'
                ...
                bannerDel({
                    api: 'plugin.bbs.Adminbbs.bannerDel',
                    id: value.id
                }).then(res => {
                    if(res.data.code == '200') {
                        this.bannerIndexs()
