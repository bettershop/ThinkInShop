...
export default {
  ...
  methods: {
    ...
    Delete(id) {
      ...
      this.$confirm(this.$t('logisticsCompanyManage.logisticsCompanyList.qrsc'), this.$t('logisticsCompanyManage.logisticsCompanyList.ts'), {
        confirmButtonText: this.$t('logisticsCompanyManage.logisticsCompanyList.okk'),
        cancelButtonText: this.$t('logisticsCompanyManage.logisticsCompanyList.ccel'),
        type: 'warning'
      }).then(() => {
        del({
