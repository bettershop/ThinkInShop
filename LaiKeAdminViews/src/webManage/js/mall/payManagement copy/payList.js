import { index, setPaymentSwitch } from "@/api/Platform/payManagement";
...
export default {
  ...
  methods: {
    ...
    parameter(value) {
      this.$router.push({
        path: "/platform/payManagement/parameterModify",
        query: {
          id: value.id,
    ...
    handleEditIcon(value) {
      this.$router.push({
        path: "/platform/payManagement/editIcon",
        query: {
          id: value.id,
          dictionaryNum: this.dictionaryNum,
          logo: value.logo,
