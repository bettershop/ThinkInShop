        ...
        <el-col :xl="18" :lg="18" :md="18" :sm="18" :xs="24" class="colLeft">
          <div class="conter">
            <div class="bnt acea-row row-middle">
              <el-col class="mb10">
                <el-button type="primary" :disabled="checkPicList.length === 0" @click="checkPics" class="mr10">使用选中图片
                </el-button>
              </el-col>
            </div>
              ...
              <el-row :gutter="24" class="conter">
                ...
                <div class="acea-row">
                  <div class="pictrueList_pic mr10 mb10" v-for="(item, index) in pictrueList" :key="index">
                    <img :class="item.isSelect ? 'on' : ''" :src="item.satt_dir" @click.stop="changImage(item, index, pictrueList)" @error="handleErrorImg" :style="{
                        width: imageSize + 'px',
                        height: imageSize + 'px'
                      }" />
                  </div>
