package com.laiketui.admins.api.admin.role;
...
public interface AdminRoleService
{
     ...
     */
    Map<String, Object> getRoleListInfo(MainVo vo, Integer status, Integer id) throws LaiKeAPIException;
     ...
     * @date 2021/1/14 9:31
     */
    Map<String, Object> getUserRoleInfo(MainVo vo, Integer id, boolean isPt,String lang_code) throws LaiKeAPIException;
