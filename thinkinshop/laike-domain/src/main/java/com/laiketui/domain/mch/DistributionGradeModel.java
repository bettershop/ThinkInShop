...
public class DistributionGradeModel implements Serializable
{

    /**
     * 分销等级规则
     * a:5:{s:7:"manybuy";s:3:"500";s:10:"manypeople";s:3:"2,3";s:6:"onebuy";s:3:"800";s:6:"recomm";s:4:"1,20";s:8:"manyyeji";s:4:"1000";}
     */

    public interface Uplevel_Obj
    {
        /**
         * 累计消费满多少
         */
        @Transient
        String MANY_BUY   = "manybuy";
        /**
         * 团队人数升级
         */
        @Transient
        String MANYPEOPLE = "manypeople";
        /**
         * 一次性消费
         */
        @Transient
        String ONE_BUY    = "onebuy";
        /**
         * 推荐指定等级会员、数量 则升级
         */
        @Transient
     ...
     * 会员专区消费金
     */
    @Column(name = "member_consumer_money")
    private String member_consumer_money;

    /**
     * 升级条件
     */
    @Column(name = "uplevel_obj")
