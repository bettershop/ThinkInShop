...
public class ConfigModel implements Serializable
{
    ...
    public String getAdmin_default_portrait() {
        return admin_default_portrait;
    }

    public void setAdmin_default_portrait(String admin_default_portrait) {
        this.admin_default_portrait = admin_default_portrait;
    }
    ...
    public void setLink_to_landing_page(String link_to_landing_page) {
        this.link_to_landing_page = link_to_landing_page;
    }
    ...
    public String getLogon_logo() {
        return logon_logo;
    }

    public void setLogon_logo(String logon_logo) {
        this.logon_logo = logon_logo;
    }
    ...
    public String getPc_mch_path()
    {
        return pc_mch_path;
    }

    public void setPc_mch_path(String pc_mch_path)
    {
        this.pc_mch_path = pc_mch_path;
    }
    ...
    public void setWatermark_name(String watermark_name)
    {
    ...
    public String toString()
    {
        return "ConfigModel{" +
                ...
                ", mch_id=" + mch_id +
                ", ip='" + ip + '\'' +
                ", uploadImg_domain='" + uploadImg_domain + '\'' +
                ", upserver='" + upserver + '\'' +
                ", uploadImg='" + uploadImg + '\'' +
                ...
                ", after_sales_issues='" + after_sales_issues + '\'' +
