...
public class ConfiGureModel implements Serializable
{
    ...
    /**
     * 积分商品所需积分-业务需求数据路无字段对应
     */
    @Transient
    private Integer integralPriceNum;

    /**
     * 虚拟商品可核销次数(暂时未使用，使用的总库存)
     */
    ...
    public void setLive_price(BigDecimal live_price)
    {
    ...
    public Integer getIntegralPriceNum()
    {
        return integralPriceNum;
    }

    public void setIntegralPriceNum(Integer integralPriceNum)
    {
        this.integralPriceNum = integralPriceNum;
    }
