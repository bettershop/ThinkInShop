...
public class OrderSettlementVo extends MainVo
{
    ...
    @ApiModelProperty(value = "供应商/店铺名称", name = "mchName")
    private String  mchSupplierName;
    @ApiModelProperty(value = "订单类型", name = "orderType", hidden = true)
    private String  orderType;
    @ApiModelProperty(value = "供应商id", name = "supplierId")
    private Integer supplierId;
    @ApiModelProperty(value = "供应商结算订单标识", name = "supplierOrder")
    private String  supplierOrder;

    public String getMchSupplierName()
    {
        return mchSupplierName;
    }

    public void setMchSupplierName(String mchSupplierName)
    {
        this.mchSupplierName = mchSupplierName;
    }
