...
public class ExpressModel implements Serializable
{
    ...
    public String getWx_delivery_id()
    {
        return wx_delivery_id;
    }

    public void setWx_delivery_id(String wx_delivery_id)
    {
        this.wx_delivery_id = wx_delivery_id;
    }
}