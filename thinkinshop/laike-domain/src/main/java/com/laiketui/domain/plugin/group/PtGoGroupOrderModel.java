 ...
 * @author Trick
 */
@Table(name = "lkt_pt_go_group_order")
public class PtGoGroupOrderModel implements Serializable
{
    /**
     * id
     */
    ...
    /**
     * 获取状态 0:未付款 1:未发货 2:待收货 3:待评论 4:退货 5:已完成 6:订单失效 7:订单  关闭 8:删除订单 9:拼团中 10:拼团失败-未退款 11:拼团失败-已退款
     *
     * @return status - 状态 0:未付款 1:未发货 2:待收货 3:待评论 4:退货 5:已完成 6:订单失效 7:订单  关闭 8:删除订单 9:拼团中 10:拼团失败-未退款 11:拼团失败-已退款
     */
    ...
    /**
     * 设置状态 0:未付款 1:未发货 2:待收货 3:待评论 4:退货 5:已完成 6:订单失效 7:订单  关闭 8:删除订单 9:拼团中 10:拼团失败-未退款 11:拼团失败-已退款
     *
     * @param status 状态 0:未付款 1:未发货 2:待收货 3:待评论 4:退货 5:已完成 6:订单失效 7:订单  关闭 8:删除订单 9:拼团中 10:拼团失败-未退款 11:拼团失败-已退款
     */
     ...
     * 设置活动id
     *
     * @param activity_no 活动id
     */
    public void setActivity_no(String activity_no)
    {
        this.activity_no = activity_no == null ? null : activity_no.trim();
    }
