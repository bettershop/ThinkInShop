 ...
 * @date 2021/2/7 14:24
 */
@Table(name = "lkt_distribution_withdraw")
public class DistributionWithdrawModel implements Serializable
{
     ...
     */
    @Transient
    public static final int WITHDRAWMODEL_EXAMIN_UNDER  = 0;
    /**
     * 1：审核通过
     */
    @Transient
    public static final int WITHDRAWMODEL_EXAMIN_PASS   = 1;
    /**
     * 2：拒绝
     */
    @Transient
    public static final int WITHDRAWMODEL_EXAMIN_REFUSE = 2;
