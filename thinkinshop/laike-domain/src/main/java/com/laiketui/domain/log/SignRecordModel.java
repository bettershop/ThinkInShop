...
public class SignRecordModel implements Serializable
{
     ...
     */
    @Transient
    public static final List<Integer> TYPE_EXPENDITURE = Arrays.asList(ScoreType.CONSUMPTION, ScoreType.SYSTEM_DIFF, ScoreType.GIVE_FRIEND
            , ScoreType.SYSTEM_LUCK_DRAW, ScoreType.OVERDUE);
    /**
     * 收入
     */
    @Transient
    public static final List<Integer> TYPE_INCOME      = Arrays.asList(ScoreType.SIGN, ScoreType.FOLLOW_ONLY, ScoreType.SYSTEM_RECHARGE,
            ScoreType.DISTRIBUTION_UPLEVEL, ScoreType.MEMBER_BIRTHDAY, ScoreType.INTEGRAL_REFUND_RETURN, ScoreType.VIP_BUY, ScoreType.INTEGRAL_FROZEN);
    ...
    public interface ScoreType
    {
         ...
         * 首次关注得积分
         */
        Integer FOLLOW_ONLY            = 2;
        /**
         * 转积分给好友
         */
        Integer GIVE_FRIEND            = 4;
        /**
         * 系统扣除
         */
        Integer SYSTEM_DIFF            = 5;
        /**
         * 系统充值
         */
         ...
         * 分销升级奖励积分
         */
        Integer DISTRIBUTION_UPLEVEL   = 9;
        /**
         * 积分过期
         */
        Integer OVERDUE                = 10;
         ...
         * 冻结积分退回
         */
        Integer INTEGRAL_FROZEN_RETURN = 15;

        /**
         * 积分解冻
         */
        Integer INTEGRAL_UNFREEZE = 16;
     ...
     *
     * @param type 类型: 0:签到 1:消费 2:首次关注得积分 3:转积分给好友 4:好友转积分 5:系统扣除 6:系统充值 7:抽奖 8:会员购物积分 9:分销升级奖励积分 10:积分过期 11.开通会员 12.会员生日特权
     */
