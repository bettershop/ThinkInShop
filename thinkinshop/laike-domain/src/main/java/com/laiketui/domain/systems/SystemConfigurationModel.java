...
public class SystemConfigurationModel implements Serializable
{
    /**
     * id
     */
     ...
     * 商城id前缀
     */
    private String store_id_prefix;
    ...
    public String getStore_id_prefix()
    {
        return store_id_prefix;
    }

    public void setStore_id_prefix(String store_id_prefix)
    {
        this.store_id_prefix = store_id_prefix;
    }
