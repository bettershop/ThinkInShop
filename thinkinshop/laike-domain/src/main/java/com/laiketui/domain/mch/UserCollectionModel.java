...
public class UserCollectionModel implements Serializable
{
    ...
    @Transient
    private Integer isAuctionGoods;

    /**
     * 店铺名称或者是商品名称搜索
     */
    @Transient
    private String mchNameOrProName;

    public Integer getIsAuctionGoods() {
        return isAuctionGoods;
    }

    public void setIsAuctionGoods(Integer isAuctionGoods) {
        this.isAuctionGoods = isAuctionGoods;
    }
