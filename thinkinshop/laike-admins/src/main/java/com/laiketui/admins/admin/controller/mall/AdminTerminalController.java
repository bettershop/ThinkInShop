package com.laiketui.admins.admin.controller.mall;
...
public class AdminTerminalController
{
    ...
    @Autowired
    private AdminTerminalService adminTerminalService;
    ...
    public Result index(MainVo vo, int type)
    {
        try
        {
            return Result.success(adminTerminalService.index(vo, type));
        }
    ...
    public Result saveApp(SaveTerminalAppVo vo)
    {
        try
        {
            adminTerminalService.saveApp(vo);
    ...
    public Result saveWeiXinApp(SaveTerminalWeiXinVo vo)
    {
        try
        {
            adminTerminalService.saveWeiXin(vo);
            return Result.success(GloabConst.ManaValue.MANA_VALUE_SUCCESS);
        }
        catch (LaiKeAPIException e)
        {
