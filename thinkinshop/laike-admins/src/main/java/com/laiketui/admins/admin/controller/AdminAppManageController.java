...
public class AdminAppManageController
{
    @Autowired
    private AdminWeixinManageService adminWeixinManageService;
    ...
    public Result getWeiXinGuideImageInfo(MainVo vo, Integer id)
    {
        try
        {
            return Result.success(adminWeixinManageService.getWeiXinGuideImageInfo(vo, id));
        }
    ...
    public Result addWeiXinGuideImage(MainVo vo, Integer id, String imgUrl, Integer sort, int type,Integer source)
    {
        try
        {
            return Result.success(adminWeixinManageService.addWeiXinGuideImage(vo, id, imgUrl, sort, type,source));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result delWeiXinGuideImage(MainVo vo, int id)
    {
        try
        {
            return Result.success(adminWeixinManageService.delWeiXinGuideImage(vo, id));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result getWeiXinTemplateInfo(MainVo vo, Integer id, Integer templateType, Integer isUse, String templateName)
    {
        try
        {
            return Result.success(adminWeixinManageService.getWeiXinTemplateInfo(vo, id, templateType, isUse, templateName));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result addWeiXinTemplate(AddWeiXinAppTemplateVo vo)
    {
        try
        {
            return Result.success(adminWeixinManageService.addWeiXinTemplate(vo));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result setUseWeiXinTemplate(int id)
    {
        try
        {
            return Result.success(adminWeixinManageService.setUseWeiXinTemplate(id));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result delWeiXinTemplate(int id)
    {
        try
        {
            return Result.success(adminWeixinManageService.delWeiXinTemplate(id));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result getPreAuthorizationCode(MainVo vo)
    {
        try
        {
            return Result.success(adminWeixinManageService.getPreAuthorizationCode(vo));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result getAuthorizationAppInfo(MainVo vo)
    {
        try
        {
            return Result.success(adminWeixinManageService.getAuthorizationAppInfo(vo));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result ticketCallBack(HttpServletRequest request, HttpServletResponse response)
    {
        try
        {
            return Result.success(adminWeixinManageService.ticketCallBack(request, response));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result revokeExamine(int storeId)
    {
        try
        {
            return Result.success(adminWeixinManageService.revokeExamine(storeId));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result delThirdMiniApp(int id)
    {
        try
        {
            return Result.success(adminWeixinManageService.delThirdMiniApp(id));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result downQrcode(int storeId, int width, int type)
    {
        try
        {
            return Result.success(adminWeixinManageService.downQrcode(storeId, width, type));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result submitAppExamine(int storeId, String templateId)
    {
        try
        {
            return Result.success(adminWeixinManageService.submitAppExamine(storeId, templateId));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
