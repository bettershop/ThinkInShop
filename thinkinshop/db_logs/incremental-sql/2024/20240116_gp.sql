...
CREATE TABLE `lkt_flashsale_activity` (
                                          ...
                                          `is_notice` int(11) NOT NULL DEFAULT '0' COMMENT '是否通知 0=未通知 1=已通知',
                                          PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=130 DEFAULT CHARSET=utf8mb4 COMMENT='限时折扣活动表';
...
CREATE TABLE `lkt_flashsale_addgoods` (
                                          ...
                                          PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=104 DEFAULT CHARSET=utf8mb4 COMMENT='限时折扣加购商品表';
...
CREATE TABLE `lkt_flashsale_config` (
                                        ...
                                        `good_switch` tinyint(4) NOT NULL DEFAULT '0' COMMENT '自动评价设置 0.关闭 1.开启',
                                        PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='限时折扣设置';
...
CREATE TABLE `lkt_flashsale_label` (
                                       ...
                                       `content` mediumtext NOT NULL COMMENT '活动说明',
                                       `add_date` datetime DEFAULT NULL COMMENT '添加时间',
                                       `update_date` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
                                       `recovery` int(11) DEFAULT '0' COMMENT '是否回收',
                                       `mch_id` int(11) NOT NULL COMMENT '店铺id',
                                       PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=118 DEFAULT CHARSET=utf8mb4 COMMENT='限时折扣活动表';
...
CREATE TABLE `lkt_flashsale_pro` (
                                     ...
                                     PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=143 DEFAULT CHARSET=utf8 COMMENT='限时折扣商品表';
...
CREATE TABLE `lkt_flashsale_record` (
                                        ...
                                        `sNo` varchar(50) NOT NULL COMMENT '限时折扣订单',
                                        `is_delete` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除 1是 0否',
                                        `add_time` datetime NOT NULL COMMENT '添加日期',
                                        PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8mb4 COMMENT='限时折扣记录表';

ALTER TABLE `lkt_flashsale_activity`
    MODIFY COLUMN `flashsale_price` decimal(11, 2) NOT NULL DEFAULT 0 COMMENT '折扣价格' AFTER `label_id`,
    MODIFY COLUMN `num` int(11) NOT NULL DEFAULT 0 COMMENT '活动库存' AFTER `buylimit`;


ALTER TABLE `lkt_flashsale_pro`
    MODIFY COLUMN `num` int(11) NOT NULL DEFAULT 0 COMMENT '活动库存' AFTER `attr_id`;


ALTER TABLE `lkt_flashsale_record`
    MODIFY COLUMN `time_id` int(11) NOT NULL DEFAULT 0 COMMENT '时段id' AFTER `activity_id`,
    MODIFY COLUMN `pro_id` int(11) NOT NULL DEFAULT 0 COMMENT '商品id' AFTER `time_id`,
    MODIFY COLUMN `attr_id` int(11) NOT NULL DEFAULT 0 COMMENT '规格id' AFTER `pro_id`,
    MODIFY COLUMN `sec_id` int(11) NOT NULL DEFAULT 0 COMMENT '限时折扣id' AFTER `attr_id`,
    MODIFY COLUMN `price` decimal(11, 2) NOT NULL DEFAULT 0 COMMENT '价格' AFTER `sec_id`,
    MODIFY COLUMN `num` int(11) NOT NULL DEFAULT 0 COMMENT '数量' AFTER `price`;

ALTER TABLE `lkt_flashsale_record`
    MODIFY COLUMN `activity_id` int(11) NOT NULL DEFAULT 1 COMMENT '活动id' AFTER `user_id`;