...
public class LaiKeApiParams implements Serializable, Cloneable
{
    ...
    public LaiKeApiParams(int pos, String name, String type, String[] annotation, String aliasNames)
    {
        ...
        this.name = name;
        this.type = type;
        this.annotation = (annotation == null ? new String[0] : annotation);
        this.aliasNames = (aliasNames == null ? "{}" : aliasNames);
    }
    ...
    {
        return annotation == null ? new String[0] : annotation;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof LaiKeApiParams))
        {
            return false;
        }
