...
public interface DictionaryNameModelMapper extends BaseMapper<DictionaryNameModel>
{
     ...
     * @date 2021/6/1 11:04
     */
    @Select("select b.id,b.sid,b.value,b.ctext as `text` from lkt_data_dictionary_name as a,lkt_data_dictionary_list b where a.name =#{name} and b.status=1 and  a.id=b.sid and b.recycle=0 ")
