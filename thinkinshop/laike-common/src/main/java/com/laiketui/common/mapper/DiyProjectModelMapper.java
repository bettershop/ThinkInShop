...
import com.laiketui.domain.diy.DiyProjectModel;
import com.laiketui.domain.vo.MainVo;
import com.laiketui.domain.vo.diy.DiyProjectVo;

import java.util.Map;

public interface DiyProjectModelMapper extends BaseMapper<DiyProjectModel>
{
     ...
     * @date 2022/04/28 16:00
     */
    Map getDiyProjectById(MainVo vo, int id) throws LaiKeAPIException;
}