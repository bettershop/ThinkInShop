...
<head>
	...
	<!-- DataTables -->
  	<link rel="stylesheet" href="${ctx}/static/adminlte/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  	<!-- daterangepicker -->
  	<link rel="stylesheet" href="${ctx}/static/adminlte/bower_components/bootstrap-daterangepicker/daterangepicker.css">
...
<!-- daterangepicker -->
<script src="${ctx}/static/adminlte/bower_components/moment/moment.min.js"></script>
<script src="${ctx}/static/adminlte/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<script src="${ctx}/static/js/joblog.index.1.js"></script>
</body>
</html>
