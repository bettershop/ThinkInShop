...
public interface OrderDubboService
{
     ...
     * @return
     */
    Map<String, Object> payment(OrderVo vo) throws LaiKeAPIException;
     ...
     *
     * @param vo       -
     * @param imgUrls  - 图片url地址
     * @param tokenKey - 登录模块key
     * @return Map
     * @throws LaiKeAPIException -
     * @author Trick
     * @date 2022-02-21 17:28:40
     */
    default Map<String, Object> returnData(ApplyReturnDataVo vo, String imgUrls, String tokenKey) throws LaiKeAPIException
    {
        return null;
    }
     ...
     * @return
     */
    Map<String, Object> cancleOrder(OrderVo vo) throws LaiKeAPIException;
     ...
     * @return
     */
    Map<String, Object> getPayment(OrderVo vo);
}
