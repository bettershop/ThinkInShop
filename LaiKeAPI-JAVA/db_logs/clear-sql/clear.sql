...
-- 后台管理员
DELETE FROM lkt_admin  WHERE id not in (1); -- 商城1的商城管理员id=541
-- 操作日志
...
-- 数据备份时间表(java没有)
-- TRUNCATE TABLE lkt_backup_time;
-- 银行卡
...
-- 上传文件记录表
delete from lkt_files_record where store_id  <> 0;
-- 钱包配置表
...
-- 奖金收益表(java没有)
-- TRUNCATE TABLE lkt_money_point;
-- 模板消息表【微信小程序订阅消息】
TRUNCATE TABLE lkt_notice;
-- 模板消息配置表(java没有)
-- TRUNCATE TABLE lkt_notice_config;
-- IM聊天记录
TRUNCATE TABLE lkt_online_message;
-- 平台控件表(java没有)
-- TRUNCATE TABLE lkt_option;
-- 订单
...
-- PC商城广告轮播图表(java没有)
-- TRUNCATE TABLE lkt_pc_mall_ad;
-- PC商城首页公告位(java没有)
-- TRUNCATE TABLE lkt_pc_mall_ad_display;
-- PC商城轮播图表(java没有)
-- TRUNCATE TABLE lkt_pc_mall_banner;
-- PC商城底部栏图片配置
TRUNCATE TABLE lkt_pc_mall_bottom;
-- PC商城首页品牌展示(java没有)
-- TRUNCATE TABLE lkt_pc_mall_brand;
-- PC商城首页分类(java没有)
-- TRUNCATE TABLE lkt_pc_mall_category;
-- PC商城栏目(java没有)
-- TRUNCATE TABLE lkt_pc_mall_column;
-- PC商城页面显示配置
TRUNCATE TABLE lkt_pc_mall_config;
-- PC商城楼层(java没有)
-- TRUNCATE TABLE lkt_pc_mall_floor;
-- PC商城首页普通展示(java没有)
-- TRUNCATE TABLE lkt_pc_mall_general;
-- 平台活动表
...
-- PC商城首页普通展示
DELETE FROM lkt_plugins WHERE store_id != 0;
-- 预售配置表
...
-- 第三方授权表
UPDATE lkt_third SET ticket = NULL,ticket_time = null ,token = NULL,token_expires = NULL,appid = NULL,appsecret = NULL,check_token = NULL,encrypt_key = NULL,serve_domain = NULL,work_domain = NULL,redirect_url = NULL,mini_url = NULL,kefu_url = NULL,qr_code = NULL,H5 = NULL,endurl = NULL;
-- 第三方用户映射表
...
-- 用户选择门店表（java没有）
-- TRUNCATE TABLE lkt_user_selects_store;
-- 提现记录
