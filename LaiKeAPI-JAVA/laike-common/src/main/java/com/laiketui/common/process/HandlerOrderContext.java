...
public class HandlerOrderContext
{
    ...
    //存放所有策略类Bean的map
    public static Map<String, Class<OrderDubboService>> orderStrategyBeanMap = new HashMap<>();

    public OrderDubboService getOrderService(String orderType) throws LaiKeAPIException
    {
        Class<OrderDubboService> strategyClass = orderStrategyBeanMap.get(orderType);
