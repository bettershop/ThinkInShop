...
public class GoodsDataUtils
{
     ...
     * 管理后台店铺商品审核通知前端路由路径
     */
    public static final String MCH_GOODS_URL = "/plug_ins/stores/goodsAudit";

    /**
     * 管理后台供应商商品审核通知前端路由路径
     */
    public static final String SUPPLIER_GOODS_URL = "/plug_ins/supplier/poolReviewed";
     ...
     * @date 2020/10/22 10:10
     */
    public static Map<String, Object> getLiveGoodsAttributeInfo(List<ConfiGureModel> confiGureModelList, BigDecimal gradeRate) throws LaiKeAPIException
    {
        try
        {
            return getLiveGoodsAttributeInfo(confiGureModelList, gradeRate, null);
        }
        catch (LaiKeAPIException l)
        {
            throw l;
     ...
     * @date 2020/10/22 10:10
     */
    public static Map<String, Object> getLiveGoodsAttributeInfo(List<ConfiGureModel> confiGureModelList, BigDecimal gradeRate, Integer attreId) throws LaiKeAPIException
    {
        Map<String, Object> resultMap = new TreeMap<>();
        ...
        try
        {
            ...
            for (ConfiGureModel confiGure : confiGureModelList)
            {
                //折扣 原来直播商品价格 * 折扣 / 10 = 优惠价
                BigDecimal vipPrice = confiGure.getLive_price();
                ...
                //skuBeanList 父节点
                Map<String, Object> skuBeanSonDetailMap = getLiveSkuBeanList(attributesList, attrStr.toString(), confiGure);
                skuBeanList.add(skuBeanSonDetailMap);
                //attribute_list 父节点
                Map<String, Object> attributeSonDetailMap = getLiveAttributeList(confiGure, attributeMap);
                attributeList.add(attributeSonDetailMap);
            }
    ...
    private static void getAttributeAttrList(String keyName, String valueName, Map<String, Object> attrListMapTemp, ConfiGureModel confiGure, boolean isChecked)
    {
        ...
        try
        {
            ...
            attrListMap.put("price", confiGure.getPrice().setScale(2, RoundingMode.HALF_UP));
            attrListMap.put("price", confiGure.getLive_price());
            attrListMap.put("integralNum", confiGure.getIntegralPriceNum());
            //是否选中
    ...
    private static Map<String, Object> getSkuBeanList(List<Map<String, Object>> attributesList, String valueName, ConfiGureModel confiGure)
    {
        ...
        try
        {
            ...
            //价格
            BigDecimal price = confiGure.getPrice().setScale(2, RoundingMode.HALF_UP);
            //库存
            ...
            //直播价格
            //积分
            Integer integralNum = confiGure.getIntegralPriceNum();
            ...
            skuBeanSonDetailMap.put("integralNum", integralNum);
        }
        catch (Exception e)
        {
            e.printStackTrace();
     ...
     * @date 2020/10/22 10:18
     */
    private static Map<String, Object> getLiveSkuBeanList(List<Map<String, Object>> attributesList, String valueName, ConfiGureModel confiGure)
    {
        Map<String, Object> skuBeanSonDetailMap = new TreeMap<>();
        try
        {
            ...
            String unit = confiGure.getUnit();
            //直播价格
            BigDecimal live_price = confiGure.getLive_price();
            //积分
            Integer integralNum = confiGure.getIntegralPriceNum();
            skuBeanSonDetailMap.put("name", valueName);
            skuBeanSonDetailMap.put("imgurl", imgurl);
            skuBeanSonDetailMap.put("cid", cid);
            skuBeanSonDetailMap.put("price", live_price);
            skuBeanSonDetailMap.put("count", stokeNum);
            skuBeanSonDetailMap.put("unit", unit);
            skuBeanSonDetailMap.put("attributes", attributesList);
            skuBeanSonDetailMap.put("integralNum", integralNum);
    ...
    private static Map<String, Object> getAttributeList(ConfiGureModel confiGure, Map<String, Object> attributeMap)
    {
        ...
        try
        {
            ...
            attrSonDetailMap.put("integralNum", confiGure.getIntegralPriceNum());
            for (Object keyObj : attributeMap.keySet())
            {
                String key      = keyObj.toString();
                String value    = attributeMap.get(key).toString();
     ...
     * @date 2020/10/22 10:18
     */
    private static Map<String, Object> getLiveAttributeList(ConfiGureModel confiGure, Map<String, Object> attributeMap)
    {
        Map<String, Object> attrSonDetailMap = new TreeMap<>();
        try
        {
            ...
            attrSonDetailMap.put("Stock", confiGure.getNum());
//            attrSonDetailMap.put("Price", confiGure.getPrice());
            attrSonDetailMap.put("Price", confiGure.getLive_price());
            attrSonDetailMap.put("Pic", confiGure.getImg());
            attrSonDetailMap.put("integralNum", confiGure.getIntegralPriceNum());
            for (Object keyObj : attributeMap.keySet())
            {
