...
public class XxlJobHelper {
     ...
     * @date 2021/4/6 16:31
     */
    public static boolean handleFail(String handleMsg, Object... objects) {
        FormattingTuple ft = MessageFormatter.arrayFormat(handleMsg, objects);
        return handleResult(XxlJobContext.HANDLE_COCE_FAIL, ft.getMessage());
    }

    public static boolean handleFail(String handleMsg, Throwable e) {
        handleFail(e);
        return handleResult(XxlJobContext.HANDLE_COCE_FAIL, e.getMessage());
    }
     ...
     * @date 2021/4/6 16:31
     */
    public static boolean handleTimeout(String handleMsg, Object... objects) {
        FormattingTuple ft = MessageFormatter.arrayFormat(handleMsg, objects);
        return handleResult(XxlJobContext.HANDLE_COCE_TIMEOUT, ft.getMessage());
    }
