...
//        }
                                     ...
                                     int connectTimeoutMs, int readTimeoutMs) throws Exception
    {
        ...
        logger.info("不需要证书的请求:参数,{}", reqBody);
        String resp = this.wxPayRequest.requestWithoutCert(urlSuffix, msgUUID, reqBody, connectTimeoutMs, readTimeoutMs, autoReport);
        logger.info("不需要证书的请求:结果,{}", resp);
        return resp;
    }
    ...
    public Map<String, String> unifiedOrder(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception
    {
        ...
        logger.info("统一下单:url,{}", url);
        if (this.notifyUrl != null)
        {
            reqData.put("notify_url", this.notifyUrl);
        }
        logger.info("统一下单:参数,{}", reqData);
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        logger.info("统一下单:unifiedOrder,{}", respXml);
        return this.processResponseXml(respXml);
    }
     ...
     * @throws Exception
     */
    public String requestWithCert(String urlSuffix, String nonce_str, String reqData,
                                  int connectTimeoutMs, int readTimeoutMs) throws Exception
    {
        String msgUUID = nonce_str;
        String resp    = this.wxPayRequest.requestWithCert(urlSuffix, msgUUID, reqData, connectTimeoutMs, readTimeoutMs, this.autoReport);
        return resp;
    }
     ...
     * @throws Exception
     */
    public String requestWithoutCert(String urlSuffix, String nonce_str, String reqData) throws Exception
    {
        String msgUUID = nonce_str;
        logger.info("不需要证书的请求:参数,{}", reqData);
        String resp = this.wxPayRequest.requestWithoutCert(urlSuffix, msgUUID, reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs(), autoReport);
        logger.info("不需要证书的请求:结果,{}", resp);
        return resp;
    }
