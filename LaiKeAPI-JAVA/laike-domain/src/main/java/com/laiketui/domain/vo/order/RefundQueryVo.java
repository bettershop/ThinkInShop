...
public class RefundQueryVo extends MainVo
{
    ...
    @ApiModelProperty(value = "售后订单id(详情)", name = "id")
    private Integer id;
    @ApiModelProperty(value = "订单id(详情)", name = "orderId")
    private Integer orderId;
    @ApiModelProperty(value = "订单id-(列表id查询)", name = "oId")
    private Integer oId;
    ...
    @ApiModelProperty(value = "售后类型 1:退货退款  2:退款 3:换货", name = "reType")
