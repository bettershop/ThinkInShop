...
public class SaveTerminalAppVo extends MainVo
{
    ...
    @ApiModelProperty(value = "安卓下载链接", name = "androidDownloadLink")
    @ParamsMapping("android_download_link")
    private String  androidDownloadLink;

    @ApiModelProperty(value = "苹果下载链接", name = "iosDownloadLink")
    @ParamsMapping("ios_download_link")
