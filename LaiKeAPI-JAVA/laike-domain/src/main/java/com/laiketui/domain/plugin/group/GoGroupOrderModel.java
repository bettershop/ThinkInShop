package com.laiketui.domain.plugin.group;
 ...
 */
@Table(name = "lkt_go_group_order")
public class GoGroupOrderModel implements Serializable
{
    ...
    /**
     * 状态 0:未付款 1:未发货 2:待收货 3:待评论 4:退货 5:已完成 6:订单失效 7:订单  关闭 8:删除订单 9:拼团中 10:拼团失败-未退款 11:拼团失败-已退款
     */
    public interface OrderStatus
    {
        int NOTPAY          = 0, NOT_DELIVER = 1, DELIVER = 2, WAIT_COMMENT = 3, COMPLETED = 5, ORDER_FAILE = 6,
                ORDER_CLOSE = 7, ORDE_DEL = 8, PT_ING = 9, PT_FIAL_NOT_REFUND = 10, PT_FIAL_REFUND = 11;
    }

    /**
     * 拼团订单类型
     */
    public interface OrderPid
    {
        /**
         * 参团订单
         **/
        String CANTUAN = "cantuan";
        /**
         * 开团订单
         **/
        String KAITUAN = "kaituan";
    }
    ...
    /**
     * 状态 0:未付款 1:未发货 2:待收货 3:待评论 4:退货 5:已完成 6:订单失效 7:订单
     */
    ...
    /**
     * 获取状态 0:未付款 1:未发货 2:待收货 3:待评论 4:退货 5:已完成 6:订单失效 7:订单
     *
     * @return status - 状态 0:未付款 1:未发货 2:待收货 3:待评论 4:退货 5:已完成 6:订单失效 7:订单
     */
    ...
    /**
     * 设置状态 0:未付款 1:未发货 2:待收货 3:待评论 4:退货 5:已完成 6:订单失效 7:订单
     *
     * @param status 状态 0:未付款 1:未发货 2:待收货 3:待评论 4:退货 5:已完成 6:订单失效 7:订单
     */
    ...
    /**
     * 获取拼团活动id lkt_group_product
     *
     * @return activity_no - 拼团活动id lkt_group_product
     */
    ...
    /**
     * 设置拼团活动id lkt_group_product
     *
     * @param activity_no 拼团活动id lkt_group_product
     */
