...
public class SearchCatVo extends MainVo
{
    ...
    private Integer num;
    @ApiModelProperty(value = "只查询一级分类", name = "onlyCid")
    private Integer onlyCid;

    public Integer getOnlyCid()
    {
        return onlyCid;
    }

    public void setOnlyCid(Integer onlyCid)
    {
        this.onlyCid = onlyCid;
    }
