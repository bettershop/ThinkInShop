...
public class User implements Serializable
{
     ...
     * 货币id
     */
    private Integer preferred_currency;
    ...
    /**
     * 是否使用的默认用户配置   1是 2否  默认否
     */
    private Integer is_default_value;

    /**
     * 是否使用的默认日期配置   1是 2否  默认否
     */
    private Integer is_default_birthday;

    private String token_living_pc;
...
//    }
    ...
    public String getStripe_email()
    {
        return stripe_email;
    }

    public void setStripe_email(String stripe_email)
    {
    ...
    public String getToken_living_pc()
    {
        return token_living_pc;
    }

    public void setToken_living_pc(String token_living_pc)
    {
        this.token_living_pc = token_living_pc;
    }
    ...
    public Integer getIs_default_birthday()
    {
        return is_default_birthday;
    }

    public void setIs_default_birthday(Integer is_default_birthday)
    {
        this.is_default_birthday = is_default_birthday;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(page, user.page) &&
                Objects.equals(cpc,user.cpc) &&
                Objects.equals(country_num,user.country_num) &&
                ...
                Objects.equals(is_default_value, user.is_default_value) &&
                Objects.equals(token_living_pc, user.token_living_pc) &&
                Objects.equals(country_num, user.country_num) &&
                Objects.equals(cpc, user.cpc);
    }
    ...
    public int hashCode()
    {
        return Objects.hash(id, page, isVip, store_id, user_id, user_name, access_id, access_key, wx_id, wx_name, gzh_id, zfb_id, bd_id,
                tt_id, clientid, sex, headimgurl, province, city, county, detailed_address, money, score,
                lock_score, password, register_data, e_mail, real_name, mobile, birthday, wechat_id, address, bank_name,
                cardholder, bank_card_number, share_num, referee, access_token, consumer_money, img_token, zhanghao, mima,
                source, login_num, verification_time, parameter, is_lock, last_time, grade, tui_id, grade_add,
                grade_m, grade_end, is_out, is_box, mch_token, lang, country_num, cpc);
    }
    ...
    public String toString()
    {
        return "User{" +
                ...
                ", is_default_birthday=" + is_default_birthday +
                ", token_living_pc='" + token_living_pc + '\'' +
                '}';
    }
}
