...
public class AdminRecordModel implements Serializable
{
    ...
    public interface Type
    {
         ...
         * 启用/禁用
         */
        Integer OPEN_OR_CLOSE  = 5;
        /**
         * 通过/拒绝
         */
        Integer PASS_OR_REFUSE = 6;
        /**
         * 删除订单
         */
        Integer DEL_ORDER      = 10;
    }
