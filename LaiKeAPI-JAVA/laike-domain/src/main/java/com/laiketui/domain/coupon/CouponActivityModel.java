...
public class CouponActivityModel implements Serializable
{
     ...
     */
    @Transient
    public static final int USE_RANG_TYPE_VIP     = 4;
    ...
    //region 发行单位 0=商城 1=自营店 2=店铺

    /**
     * 发行单位 0=商城 1=自营店 2=店铺
     */
...
//        RETURN_AMT(0, "商城"),
         ...
         * 自营店
         */
//        RETURN_GOODS_AMT(1, "自营店"),
        UNIT_STORE_MCH(1, "自营店"),
        /**
         * 店铺
         */
//        RETURN_BACK_GOODS(2, "店铺");
        UNIT_MCH(2, "店铺");
        ...
        IssueUnit(Integer type, String name)
        {
            key = type;
            value = name;
        }
        ...
        {
            //获取所有枚举集合
            IssueUnit[] enums = values();
            for (IssueUnit enumType : enums)
            {
    ...
    public Integer getIssue_unit()
    {
        return issue_unit;
    }

    public void setIssue_unit(Integer issue_unit)
    {
     ...
     * 系统已经发放
     */
    private Integer is_auto_push;

    public Integer getIs_auto_push()
    {
        return is_auto_push;
    }

    public void setIs_auto_push(Integer is_auto_push)
    {
        this.is_auto_push = is_auto_push;
    }
