...
public class OrderModel implements Serializable
{
     ...
     */
    @Transient
    public final static int SELF_LIFTING_STORE_SELF   = 2;
     ...
     */
    @Transient
    public static final int ORDER_TYPE_YH = 1;
    /**
     * 未发货
     */
    @Transient
    public final static int ORDER_TYPE_DP = 2;
    /**
     * 待收货
     */
    @Transient
    public final static int ORDER_TYPE_PT = 3;
    ...
    /**
     * 历史总金额
     * [第三方退款需要传入订单总金额,如果一个订单多个商品，只退一个商品z_price会发生变化，另外一个商品退款时没有之前订单总价导致第三方核对金额退款失败]
     */
     ...
     * 历史总运费
     */
    private BigDecimal old_freight;
     ...
     * 店铺是否操作代发 0.否 1.是
     */
    private Integer is_lssued;

    /**
     * 订单当前失效时间
     */
    private Integer orderFailureTime;
    ...
    /**
     * 微信小程序订单状态枚举：(1) 待发货；(2) 已发货；(3) 确认收货；(4) 交易完成；(5) 已退款。
     */
    private Integer wx_order_status;

    /**
     * 是否分账 0不分账，1分账
     */
    private Integer dividend_status;

    public Integer getDividend_status()
    {
        return dividend_status;
    }

    public void setDividend_status(Integer dividend_status)
    {
        this.dividend_status = dividend_status;
    }

    /**
     * 虚拟商品预约时间
     */
    private String store_write_time;

    /**
     * 订单取消方式
     */
    private Integer cancel_method;
    ...
    /**
     * 凭证审核状态 0.未上传凭证 1.待审核 2.通过 3.拒绝
     */
     ...
     */
    private String shop_cpc;


    public String getShop_cpc() {
        return shop_cpc;
    }

    public void setShop_cpc(String shop_cpc) {
        this.shop_cpc = shop_cpc;
    }
    ...
    public Integer getCancel_method()
    {
        return cancel_method;
    }

    public void setCancel_method(Integer cancel_method)
    {
    ...
    public Integer getIs_lssued()
    {
        return is_lssued;
    }

    public void setIs_lssued(Integer is_lssued)
    {
        this.is_lssued = is_lssued;
    }
     ...
     * 历史订单金额
     *
     * @return old_total 历史订单金额(只有退款时使用)
     */
     ...
     * @return
     */
    public Integer getVip_source()
    {
        return vip_source;
    }

    public void setVip_source(Integer vip_source)
    {
    ...
    /**
     * 设置优惠金额
     * 【如果此字段有值，请保证 coupon_price>=preferential_amount 】
     *
    ...
    public Integer getOrderFailureTime()
    {
        return orderFailureTime;
    }

    public void setOrderFailureTime(Integer orderFailureTime)
    {
    ...
    public BigDecimal getOld_freight()
    {
        return old_freight;
    }

    public void setOld_freight(BigDecimal old_freight)
    {
        this.old_freight = old_freight;
    }


    public Integer getWx_order_status()
    {
        return wx_order_status;
    }

    public void setWx_order_status(Integer wx_order_status)
    {
        this.wx_order_status = wx_order_status;
    }

    public String getStore_write_time()
    {
        return store_write_time;
    }

    public void setStore_write_time(String store_write_time)
    {
        this.store_write_time = store_write_time;
    }
