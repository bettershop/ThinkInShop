...
@Table(name = "lkt_supplier_pro")
public class SupplierProModel implements Serializable
{
    /**
     * 商品id
     */
    ...
    /**
     * 状态 1:待上架 2:上架 3:下架 4.违规下架 5.断供
     */
     ...
     * 显示位置排序
     */
    private Integer display_position_sort;
    ...
    /**
     * 获取商品类型 0.实物商品 1.虚拟商品
     *
     * @return commodity_type - 商品类型 0.实物商品 1.虚拟商品
     */
    ...
    /**
     * 设置商品类型 0.实物商品 1.虚拟商品
     *
     * @param commodity_type 商品类型 0.实物商品 1.虚拟商品
     */
    ...
    /**
     * 获取产品值属性 1：新品,2：热销，3：推荐(字典值 商品标签)
     *
     * @return s_type - 产品值属性 1：新品,2：热销，3：推荐(字典值 商品标签)
     */
    ...
    /**
     * 设置产品值属性 1：新品,2：热销，3：推荐(字典值 商品标签)
     *
     * @param s_type 产品值属性 1：新品,2：热销，3：推荐(字典值 商品标签)
     */
    ...
    /**
     * 获取状态 1:待上架 2:上架 3:下架 4.违规下架 5.断供
     *
     * @return status - 状态 1:待上架 2:上架 3:下架 4.违规下架 5.断供
     */
    ...
    /**
     * 设置状态 1:待上架 2:上架 3:下架 4.违规下架 5.断供
     *
     * @param status 状态 1:待上架 2:上架 3:下架 4.违规下架 5.断供
     */
     ...
     */
    public void setMch_status(Integer mch_status)
    {
     ...
     */
    public void setIs_zixuan(Integer is_zixuan)
    {
    ...
    {
        this.cover_map = cover_map == null ? null : cover_map.trim();
    }

    /**
     * 获取分类排序
     *
     * @return class_sort - 分类排序
     */
     ...
     * 获取显示位置排序
     *
     * @return display_position_sort - 显示位置排序
     */
    public Integer getDisplay_position_sort()
    {
        return display_position_sort;
    }

    /**
     * 设置显示位置排序
     *
     * @param display_position_sort 显示位置排序
     */
    public void setDisplay_position_sort(Integer display_position_sort)
    {
        this.display_position_sort = display_position_sort;
    }
    ...
    public String getOutage_time()
    {
        return outage_time;
    }

    public void setOutage_time(String outage_time)
    {
