...
public class FilesRecordModel implements Serializable
{
    @Id
    ...
    public Integer getDiy_id() {
        return diy_id;
    }

    public void setDiy_id(Integer diy_id) {
        this.diy_id = diy_id;
    }
    ...
    /**
     * 设置上传方式 1:本地 2:阿里云 3:腾讯云 4:七牛云 5:MinIo
     *
