...
@Table(name = "lkt_mch")
public class MchModel implements Serializable
{
    ...
    /**
     * 是否开启店铺主页领卷人口 0关闭 、1开启
     */
    @Column(name = "is_open_coupon")
     ...
     * 新客户下单数
     */
    private Integer new_user_order_num;

    public Integer getNew_user_order_num()
    {
        return new_user_order_num;
    }

    public void setNew_user_order_num(Integer new_user_order_num)
    {
        this.new_user_order_num = new_user_order_num;
    }
