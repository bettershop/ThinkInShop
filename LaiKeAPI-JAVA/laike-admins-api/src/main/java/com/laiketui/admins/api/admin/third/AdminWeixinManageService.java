package com.laiketui.admins.api.admin.third;
...
public interface AdminWeixinManageService
{
     ...
     */
    boolean addWeiXinGuideImage(MainVo vo, Integer id, String imgUrl, Integer sort, int type,Integer source) throws LaiKeAPIException;
