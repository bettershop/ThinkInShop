...
public class AdminDataManagerController
{
    ...
    public Result getAddUserInfo(MainVo vo, String startDate, String endDate)
    {
        try
        {
            return Result.success(adminDataService.getAddUserInfo(vo, startDate, endDate));
        }
    ...
    public Result getAddUserList(MainVo vo, String startDate, String endDate)
    {
        try
        {
            return Result.success(adminDataService.getAddUserList(vo, startDate, endDate));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result getUserDistributionInfo(MainVo vo, String startDate, String endDate)
    {
        try
        {
            return Result.success(adminDataService.getUserDistributionInfo(vo, startDate, endDate));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result getUserConsumptionInfo(MainVo vo, String startDate, String endDate)
    {
        try
        {
            return Result.success(adminDataService.getUserConsumptionInfo(vo, startDate, endDate));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result getOrderReport(MainVo vo, String startDate, String endDate, Integer type)
    {
        try
        {
            return Result.success(adminDataService.getOrderReport(vo, startDate, endDate, type));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result getGoodsReport(MainVo vo)
    {
        try
        {
            return Result.success(adminDataService.getGoodsReport(vo));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result getGoodsReportGoodsList(MainVo vo)
    {
        try
        {
            return Result.success(adminDataService.getGoodsReportGoodsList(vo));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
