...
public class AdminShopManageController
{
    ...
    @Autowired
    private AdminShopManageService adminShopManageService;
    ...
    public Result getShopInfo(MainVo vo, String storeName, String startDate, String endDate, HttpServletResponse response)
    {
        try
        {
            Map<String, Object> ret = adminShopManageService.getShopInfo(vo, storeName, startDate, endDate, response);
    ...
    public Result setStoreOpenSwitch(MainVo vo, Integer id)
    {
        try
        {
            return Result.success(adminShopManageService.setStoreOpenSwitch(vo, id));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result setStoreDefaultSwitch(MainVo vo, Integer store_id)
    {
        try
        {
            adminShopManageService.setStoreDefaultSwitch(vo, store_id);
    ...
    public Result addStore(HttpServletRequest request, AddShopVo vo)
    {
        try
        {
            ...
            return Result.success(adminShopManageService.addStore(vo, ip));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result delStore(MainVo vo, int id)
    {
        try
        {
            return Result.success(adminShopManageService.delStore(vo, id));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    public Result resetAdminPwd(MainVo vo, int adminId, String pwd)
    {
        try
        {
            return Result.success(adminShopManageService.resetAdminPwd(vo, adminId, pwd));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    @ApiOperation("判断商城是否有自营店")
    @PostMapping("/checkShopHavaSelfOwnedShop")
    @HttpApiMethod(apiKey = "saas.shop.checkShopHavaSelfOwnedShop")
    public Result checkShopHavaSelfOwnedShop(MainVo vo)
    {
        try
        {
            return Result.success(adminShopManageService.checkShopHavaSelfOwnedShop(vo));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    @ApiOperation("获取语种和币种")
    @PostMapping("/getLandingCurrency")
    @HttpApiMethod(apiKey = "saas.shop.getLandingCurrency")
    public Result getLandingCurrency(MainVo vo)
    {
        try
        {
            return Result.success(adminShopManageService.getLandingCurrency(vo));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
