package com.laiketui.admins.admin.services.third;

import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.TypeReference;
import com.laiketui.admins.api.admin.third.AdminWeixinManageService;
...
import com.laiketui.common.service.dubbo.third.dist.AesException;
import com.laiketui.common.service.dubbo.third.dist.WXBizMsgCrypt;
 ...
 */
@Service
public class AdminWeixinManageServiceImpl implements AdminWeixinManageService
{
    private final Logger logger = LoggerFactory.getLogger(AdminWeixinManageServiceImpl.class);
    ...
    public Map<String, Object> getWeiXinGuideImageInfo(MainVo vo, Integer id) throws LaiKeAPIException
    {
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "getWeiXinGuideImageInfo");
        }
        return resultMap;
    }

    @Override
    public boolean addWeiXinGuideImage(MainVo vo, Integer id, String imgUrl, Integer sort, int type,Integer source) throws LaiKeAPIException
    {
        try
        {
            int count;
            ...
            {
                throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_YDTBNWK, "引导图不能为空");
            }
            ...
            if (id != null && id > 0)
            {
                ...
                {
                    throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_YDTBCZ, "引导图不存在");
                }
            }
            GuideModel guideModelSave = new GuideModel();
            guideModelSave.setImage(ImgUploadUtils.getUrlImgByName(imgUrl, true));
            guideModelSave.setSource(source);
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "addWeiXinGuideImage");
        }
    }
    ...
    public boolean delWeiXinGuideImage(MainVo vo, int id) throws LaiKeAPIException
    {
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "delWeiXinGuideImage");
        }
    }
    ...
    public Map<String, Object> getWeiXinTemplateInfo(MainVo vo, Integer id, Integer templateType, Integer isUse, String templateName) throws LaiKeAPIException
    {
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "getWeiXinTemplateInfo");
        }
        return resultMap;
    }
    ...
    public boolean addWeiXinTemplate(AddWeiXinAppTemplateVo vo) throws LaiKeAPIException
    {
        try
        {
            ...
            {
                throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_XYBNWK, "行业不能为空");
            }
            if (StringUtils.isEmpty(vo.getTemplateId()))
            {
                throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_XCXMBBNWK, "小程序模板id不能为空");
            }
            if (StringUtils.isEmpty(vo.getText()))
            {
                throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_MBJJBNWK, "模板简介不能为空");
            }
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "addWeiXinTemplate");
        }
    }
    ...
    public boolean setUseWeiXinTemplate(int id) throws LaiKeAPIException
    {
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "stopWeiXinTemplate");
        }
    }
    ...
    public boolean delWeiXinTemplate(int id) throws LaiKeAPIException
    {
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "delWeiXinTemplate");
        }
    }
    ...
    public Map<String, Object> getPreAuthorizationCode(MainVo vo) throws LaiKeAPIException
    {
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "getPreAuthorizationCode");
        }
        return resultMap;
    }
    ...
    public Map<String, Object> getAuthorizationAppInfo(MainVo vo) throws LaiKeAPIException
    {
        ...
        try
        {
            ...
            if (thirdMiniInfoModel == null)
            {
                throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WSQQFHSQY, "未授权,请返回授权页");
            }
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "getAuthorizationAppInfo");
        }
        return resultMap;
    }
    ...
    public String ticketCallBack(HttpServletRequest request, HttpServletResponse response) throws LaiKeAPIException
    {
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "ticketCallBack");
        }
        return null;
    }
    ...
    public String revokeExamine(int storeId) throws LaiKeAPIException
    {
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "revokeExamine");
        }
    }
    ...
    public String submitAppExamine(int storeId, String templateId) throws LaiKeAPIException
    {
        try
        {
            ...
            if (thirdMiniInfoModel == null)
            {
                throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_XCXWSH, "小程序未审核");
            }
            //appid
            ...
            {
                throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_TJSHSBQCKSHRZ, "提交审核失败，请查看审核日志");
            }
            //获取授权token
            ...
            {
                throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_SZFWQYMSB, "设置服务器域名失败");
            }
            //提交审核
            if (!publicThirdService.submitReview(storeId))
            {
                throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_SHTJSB, "审核提交失败");
            }
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "submitAppExamine");
        }
    }
    ...
    public String downQrcode(int storeId, int width, int type) throws LaiKeAPIException
    {
        try
        {
            ...
            try
            {
                ...
                fileList.add(file);
                List<String> imageUrlList = publiceService.uploadImage(fileList, GloabConst.UploadConfigConst.IMG_UPLOAD_OSS, Integer.parseInt(DictionaryConst.StoreSource.LKT_LY_001), storeId);
            ...
            catch (Exception e)
            {
                ...
                throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "downQrcode");
            }
            finally
            {
                if (stream != null)
        ...
        catch (Exception e)
        {
            ...
            throw new LaiKeAPIException(ErrorCode.BizErrorCode.ERROR_CODE_WLYC, "网络异常", "downPtQrcode");
        }
    }
