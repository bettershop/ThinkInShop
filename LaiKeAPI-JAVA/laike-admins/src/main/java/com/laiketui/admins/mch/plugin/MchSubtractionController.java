...
import com.laiketui.admins.api.mch.plugin.MchSubtractionService;
...
@Api(tags = "后台满减管理接口")
@RestController
@RequestMapping("/pc/subtraction")
public class MchSubtractionController
{

    @Autowired
    private MchSubtractionService subtractionService;
    ...
    @PostMapping("/index")
    @HttpApiMethod(urlMapping = "pc.subtraction.index")
    public Result index(MainVo vo, String title, Integer status, Integer id) throws LaiKeAPIException
    {
        try
        {
            return Result.success(subtractionService.index(vo, title, status, id));
        }
    ...
    @HttpApiMethod(urlMapping = "pc.subtraction.addSubtraction")
    public Result addSubtraction(AddSubtractionVo vo) throws LaiKeAPIException
    {
        try
        {
            return Result.success(subtractionService.addSubtraction(vo));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    @HttpApiMethod(urlMapping = "pc.subtraction.subtractionSwitch")
    public Result subtractionSwitch(MainVo vo, int id) throws LaiKeAPIException
    {
        try
        {
            return Result.success(subtractionService.subtractionSwitch(vo, id));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    @ApiOperation("删除活动")
    @PostMapping("/del")
    @HttpApiMethod(urlMapping = "pc.subtraction.del")
    public Result del(MainVo vo, int id) throws LaiKeAPIException
    {
        try
        {
            return Result.success(subtractionService.del(vo, id));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    @HttpApiMethod(urlMapping = "pc.subtraction.getonfigInfo")
    public Result getonfigInfo(MainVo vo, int id) throws LaiKeAPIException
    {
        try
        {
            return Result.success(subtractionService.getonfigInfo(vo, id));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    @HttpApiMethod(urlMapping = "pc.subtraction.getSubGoods")
    public Result getSubGoods(MainVo vo, Integer classId, Integer brandId, String title) throws LaiKeAPIException
    {
        try
        {
            return Result.success(subtractionService.getSubGoods(vo, classId, brandId, title));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
    ...
    @HttpApiMethod(urlMapping = "pc.subtraction.addSubConfig")
    public Result addSubConfig(AddSubConfigVo vo) throws LaiKeAPIException
    {
        try
        {
            return Result.success(subtractionService.addSubConfig(vo));
        }
        catch (LaiKeAPIException e)
        {
            return Result.error(e.getCode(), e.getMessage());
