package com.laiketui.apps.api.app.integral;
 ...
 */
public interface AppsCstrIntegralService
{
     ...
     */
    Map<String, Object> integralOrder(MainVo vo, String orderType) throws LaiKeAPIException;
}
