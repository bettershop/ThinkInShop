 ...
 */
public interface SupplierMchOrderService
{
     ...
     */
    Map<String, Object> orderIndex(MchOrderIndexVo vo, HttpServletResponse response) throws LaiKeAPIException;
     ...
     * @throws LaiKeAPIException-
     */
    void del(MainVo vo, String oid) throws LaiKeAPIException;
     ...
     * @throws LaiKeAPIException
     */
    Map<String, Object> ordersNum(MainVo vo) throws LaiKeAPIException;
